...
export const MENU_ITEMS: Item[] = [
    // --- Hot Coffee ---
    { id: 1, name: "Cappuccino", price: "₹180", popular: true, category: "Hot Coffee" },
    { id: 2, name: "Latte", price: "₹200", popular: true, category: "Hot Coffee" },
    { id: 3, name: "Americano", price: "₹150", popular: false, category: "Hot Coffee" },
    { id: 4, name: "Filter Coffee", price: "₹120", popular: true, category: "Hot Coffee" },
    // --- Cold Coffee ---
    { id: 5, name: "Cold Brew", price: "₹220", popular: true, category: "Cold Coffee" },
    { id: 6, name: "Iced Latte", price: "₹200", popular: false, category: "Cold Coffee" },
    { id: 7, name: "Frappe", price: "₹250", popular: false, category: "Cold Coffee" },
    // --- Non Coffee ---
    { id: 8, name: "Matcha Latte", price: "₹220", popular: false, category: "Non Coffee" },
    { id: 9, name: "Hot Chocolate", price: "₹200", popular: true, category: "Non Coffee" },
    // --- Bakery ---
    { id: 10, name: "Croissant", price: "₹150", popular: true, category: "Bakery" },
    { id: 11, name: "Chocolate Croissant", price: "₹170", popular: false, category: "Bakery" },
    { id: 12, name: "Brownie", price: "₹120", popular: true, category: "Bakery" },
    { id: 13, name: "Banana Cake", price: "₹180", popular: false, category: "Bakery" },
    // --- Savory ---
    { id: 14, name: "Paneer Sandwich", price: "₹220", popular: true, category: "Savory" },
    { id: 15, name: "Chicken Wrap", price: "₹250", popular: false, category: "Savory" },
];
